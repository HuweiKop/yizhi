...
public class Sender2 {  
  ...
  public static void sendMessage(Session session, MessageProducer producer)  
      ...
      for (int i = 1; i <= SEND_NUMBER; i++) {  
    	  MessageObjedt object = new MessageObjedt();
    	  object.setParameter(1);
    	  object.setClassName("com.ideabinder.test.activemq_test.test.UserService");
    	  object.setMethodName("getUserById");
    	  object.setParameter(i);
