...
<script type="text/javascript">
	$(function() {
		...
		$("#submit").click(function() {
			var id = 0;
			var url = "createSurgeryMethod";
			if ($("#surgeryMethodId").val() != "") {
				url = "updateSurgeryMethod";
				id = $("#surgeryMethodId").val();
			}
	...
	function init() {
		if ($("#surgeryMethodId").val() == "") {
			...
			$.ajax({
				type : "GET",
				url : "getSurgeryMethodDetail",
				contentType : "application/json",
				data : {
					surgeryMethodId : $("#surgeryMethodId").val()
				},
				dataType : "json",
				success : function(data) {
					$("#name").val(data.data.surgeryMethod.name);
					$("#pinyinName").val(data.data.surgeryMethod.pinyinName);
					$("#notes").val(data.data.surgeryMethod.notes);
...
<body>
	...
	<input type="hidden" id="surgeryMethodId" value="${surgeryMethodId}" />
	<div id="page-wrapper">
		<div id="page-inner">
			<div class="row">
				<div class="col-md-12">
					<h1 class="page-head-line">编辑手术项</h1>
					<h1 class="page-subhead-line">编辑手术项
					<a href="<%=request.getContextPath()%>/web/disease/surgeryMethodList" id="returnList">返回列表</a></h1>
			...
			<div class="row">
				<div class="col-md-10 col-sm-8 col-xs-12">
					<div class="panel panel-info">
						<div class="panel-heading">编辑手术项</div>
